...
//                        .padding(.vertical, 5)
                ...
                //Enhanced Circle Threads Section
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 12) {
                                ForEach(pollsViewModel.polls) { poll in
                                    PollCard(poll: poll) { option in
                                        pollsViewModel.vote(poll: poll, option: option)
                                    }
                                    .frame(width: 300)
                                }
                                
                                if pollsViewModel.polls.isEmpty {
                                    VStack(spacing: 8) {
                                        ...
                                        Text("Create a poll to gather opinions!")
                                            .font(.system(size: 13))
                                            .foregroundColor(.secondary)
                                            .multilineTextAlignment(.center)
                                    }
