...
struct ManufacturingResources: View {
    var quizAnswers: ManufacturingQuizAnswers
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Manufacturers Near You")
            .onAppear {
    ...
    func fetchResources(keyword: String) {
        ...
        URLSession.shared.dataTask(with: url) { data, response, error in
            guard let data = data, error == nil else {
                print("❌ Error fetching manufacturing resources:", error?.localizedDescription ?? "Unknown error")
                return
            }
...
struct ManufacturingResources_Previews: PreviewProvider {
