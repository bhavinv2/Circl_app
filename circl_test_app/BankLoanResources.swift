...
struct BankLoanResources: View {
    var quizAnswers: BankLoanQuizAnswers
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Lenders Near You")
            .onAppear {
...
struct BankLoanResources_Previews: PreviewProvider {
    static var previews: some View {
        BankLoanResources(
            quizAnswers: BankLoanQuizAnswers(
                locationPref: "Chicago",
