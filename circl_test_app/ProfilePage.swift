...
struct ProfilePage: View {
    ...
    var body: some View {
        Group {
            if isCompactDevice {
                // Mobile layout with custom header and tabs
                mobileLayout
            } else {
                // iPad/Mac layout with adaptive system
                adaptiveLayout
            }
        }
    }
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView {
                        VStack(spacing: 0) {
                            ...
                            VStack(spacing: 24) {
                                // Premium Subscribe Button - Full Width
                                Button(action: {
                                ...
                                // Adaptive Grid for detail sections
                                AdaptiveGrid {
                                    // About Section
                                ...
                                // Entrepreneurial History Section - Full Width
    ...
    // MARK: - Adaptive Layout (iPad/Mac)
    var adaptiveLayout: some View {
        return AdaptivePageWrapper<AnyView>.withHeaderActions(
                title: "Profile",
                headerActions: [
                    ...
                    HeaderAction(icon: "briefcase.fill") {
                        showingBusinessProfile = true
                    }
                ]
            ) {
